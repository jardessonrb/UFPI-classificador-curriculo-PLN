...
def main() -> None:
    ...
    gupy = GupyScrapping("")
    gupy.buscar_descricao_vaga(link_vaga="https://dock.gupy.io/job/eyJqb2JJZCI6ODAzMTEwNywic291cmNlIjoiZ3VweV9wb3J0YWwifQ==?jobBoardSource=gupy_portal", 
                               nome_arquivo="teste_classificacao_topicos.txt", 
                               caminho_pasta="teste_classificacao_topico")
